...
const RoundHistory = ({ isOpen, onClose, onLoadRound, userId, onRefresh }) => {
  ...
  const ConfirmDialog = () => (
    <div className="fixed inset-0 overflow-y-auto z-50 flex items-center justify-center">
      ...
      <div className="relative bg-gray-900 rounded-lg max-w-md w-full mx-auto p-6 shadow-2xl border border-gray-700">
    ...
    <div className="overflow-x-auto">
      <table className="w-full divide-y divide-gray-700">
        <thead className="bg-transparent">
          <tr>
            <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-teal-500 uppercase tracking-wider">Dataset</th>
            <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-teal-500 uppercase tracking-wider">Date</th>
            <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-teal-500 uppercase tracking-wider">Accuracy</th>
            <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-teal-500 uppercase tracking-wider">Matches</th>
            <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-teal-500 uppercase tracking-wider">Status</th>
            <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-teal-500 uppercase tracking-wider">Actions</th>
          </tr>
        </thead>
          ...
          {rounds.map((round) => (
            <tr key={round.id} className="hover:bg-gray-900 transition-colors">
              ...
              <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <button
                  onClick={() => onLoadRound(round.id, round.dataset_name)}
                  className="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded text-white bg-teal-600 hover:bg-teal-700 mr-2"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM6.293 6.707a1 1 0 010-1.414l3-3a1 1 0 011.414 0l3 3a1 1 0 01-1.414 1.414L11 5.414V13a1 1 0 11-2 0V5.414L7.707 6.707a1 1 0 01-1.414 0z" clipRule="evenodd" />
                  </svg>
  ...
  return (
    <div className="fixed inset-0 overflow-y-auto z-50">
      <div className="flex items-center justify-center min-h-screen px-4">
        ...
        <div className="relative bg-black rounded-lg shadow-xl max-w-6xl w-full mx-auto p-6 border border-gray-800">
          <div className="flex justify-between items-center border-b border-gray-700 pb-4 mb-6">
            <h2 className="text-xl font-bold text-white">Your Round History</h2>
            <button
              onClick={onClose}
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center py-8">
              ...
              <p className="text-white text-lg">Loading your round history...</p>
            </div>
          ) : error ? (
            <div className="bg-red-900 border border-red-700 rounded-md p-4 flex items-start">
              ...
              <div>
                ...
                <button 
                  onClick={handleRetry}
                  className="mt-2 text-teal-300 underline hover:text-teal-200"
                >
                  Try Again
                </button>
              </div>
