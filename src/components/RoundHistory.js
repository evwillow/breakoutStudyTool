    ...
    <div className="border rounded-lg p-4 mb-3 bg-white shadow-md hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 px-3 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-sm rounded-md shadow hover:from-blue-600 hover:to-blue-700 transition flex items-center justify-center"
        >
    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-2 sm:p-4 backdrop-blur-sm">
      <div className="bg-white p-4 sm:p-6 rounded-lg shadow-xl w-full sm:w-3/4 max-w-4xl max-h-[90vh] sm:max-h-[80vh] overflow-y-auto">
          ...
          <>
            ...
            <div className="hidden sm:block">
              <table className="w-full border-collapse rounded-lg overflow-hidden">
                ...
                <tbody>
                  {rounds.map((round) => (
                    <tr key={round.id} className="hover:bg-blue-50 transition-colors">
                      ...
                      <td className="border border-gray-200 p-3">
                        <div className="flex space-x-2">
                          <button
                            onClick={() => onLoadRound(round.id, round.dataset_name)}
                            className="px-3 py-1 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-md shadow hover:from-blue-600 hover:to-blue-700 transition flex items-center"
                          >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                              <path fillRule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM6.293 6.707a1 1 0 010-1.414l3-3a1 1 0 011.414 0l3 3a1 1 0 01-1.414 1.414L11 5.414V13a1 1 0 11-2 0V5.414L7.707 6.707a1 1 0 01-1.414 0z" clipRule="evenodd" />
                            </svg>
        ...
        <div className="mt-6 flex justify-end">
          <button
            onClick={onClose}
            className="px-4 py-2 bg-gradient-to-r from-gray-500 to-gray-600 text-white rounded-md shadow hover:from-gray-600 hover:to-gray-700 transition flex items-center"
          >
