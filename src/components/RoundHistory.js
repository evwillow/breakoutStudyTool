      ...
      <div className="bg-soft-white p-4 sm:p-6 rounded-lg shadow-xl w-full sm:w-3/4 max-w-4xl max-h-[90vh] sm:max-h-[80vh] overflow-y-auto">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-8">
            ...
            <p className="text-teal-600 text-lg">Loading your round history...</p>
          </div>
        ) : error ? (
          ...
          <div className="text-center py-8 bg-soft-gray-50 rounded-lg border border-gray-200">
            ...
            <p className="text-teal-700 text-lg mb-2">No rounds found</p>
            <p className="text-teal-600">Complete a round to see your history here</p>
          </div>
        ) : (
          <>
            {/* Mobile view - cards */}
            ...
            <div className="hidden sm:block">
              <table className="w-full border-collapse rounded-lg overflow-hidden">
                <thead>
                  <tr className="bg-gradient-to-r from-teal-50 to-teal-100 text-teal-700">
                ...
                <tbody>
                  {rounds.map((round) => (
                    <tr key={round.id} className="hover:bg-soft-gray-50 transition-colors">
                      <td className="border border-gray-200 p-3 text-teal-700">
