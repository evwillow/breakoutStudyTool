...
const FEATURE_NAMES = [
  "6,490 curated breakouts",
  "Daily & after chart pairs",
  "Session scores in Supabase",
  "Timer-based trading reps",
];
...
const FEATURE_CARDS = [
  {
    ...
    description: "Every drill pulls from the in-repo quality_breakouts library—6,490 cleaned breakout folders generated from split-adjusted daily data since 1990.",
    icon: (
  ...
  },
  {
    ...
    description: "Each marker you place is scored against the post-breakout high and saved to Supabase rounds, so accuracy trends stay attached to your account.",
    icon: (
      <svg className="w-8 h-8 text-turquoise-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
        <path d="M3 7h18" />
        <path d="M5 11h6" />
  ...
  },
  {
    ...
    description: "Hit reveal to animate the after-chart overlay and highlight the breakout target the scorer uses, making the comparison instant and transparent.",
    icon: (
      <svg className="w-8 h-8 text-turquoise-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
  ...
  },
  {
    ...
    description: "Open the built-in folder browser to review daily, monthly, and prior breakout files for the same ticker without leaving the session.",
    icon: (
      <svg className="w-8 h-8 text-turquoise-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
        <path d="M12 3v18" />
...
const HOW_IT_WORKS_STEPS = [
  {
    ...
    description: "Select any ticker/date folder from the quality_breakouts library (6,490+ directories generated by the included Python script).",
  },
  {
    title: "Mark your target",
    description: "Before the reveal, click the chart where you expect the breakout to run. The timer keeps each repetition fast.",
  },
  {
    title: "Reveal & score",
    description: "We compare your selection to the post-breakout high, calculate price accuracy, and log the attempt automatically.",
  },
  {
    title: "Review your rounds",
    description: "Round History surfaces your Supabase records so you can reload, analyze, or clear prior sessions whenever you want.",
  },
];
...
const FAQ_ITEMS = [
  {
    ...
    answer: "The app reads directly from src/data-processing/ds/quality_breakouts—6,490 breakout folders produced by the quality_breakouts.py script using split-adjusted daily data dating back to 1990.",
  },
  {
    question: "How is feedback generated?",
    answer: "After you click, we convert that point to price/time coordinates and compare it to the peak close in the after-data. The resulting score is 95% price accuracy, with timing recorded for context.",
  },
  {
    question: "Where is my progress saved?",
    answer: "Round summaries and individual matches are written to Supabase via the /api/game routes. The Round History modal lets you reload, download, or delete those records whenever you like.",
  },
]
...
const LandingPage = ({ onSignIn }) => {
  ...
  const structuredData = useMemo(() => ({
    ...
    "description": "Train breakout recognition with focused drills, instant after-charts, and feedback anchored in the repo’s quality_breakouts dataset.",
    "publisher": {
      "@type": "Organization",
      "name": "Breakout Study Tool"
    },
    "mainEntity": {
      ...
      "description": "In-repo breakout library generated by quality_breakouts.py with 6,490 folders of historical setups.",
      "includedInDataCatalog": "Breakout Study Tool",
      "isBasedOn": "quality_breakouts.py",
      "keywords": [
        "breakout trading drills",
        "stock breakout practice",
        "quality_breakouts dataset",
        "Supabase trading analytics"
      ]
    }
  }), []);
          ...
          <div className="flex flex-col items-start text-left gap-6 justify-center">
            <div>
              ...
              <p className="mt-3 text-lg sm:text-xl text-emerald-100/90 max-w-2xl font-semibold">
                Focused drills, instant after-charts, and feedback anchored in the repo’s own quality_breakouts dataset.
              </p>
            </div>
            ...
            <p className="text-base sm:text-lg text-white/80 leading-relaxed max-w-2xl">
              Practice on 6,490 archived breakouts, place a target before reveal, then watch your score log to Supabase so you can revisit every round.
            </p>
